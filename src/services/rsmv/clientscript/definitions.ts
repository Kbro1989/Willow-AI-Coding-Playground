...
(globalThis as any).debugkey = debugKey;
...
export const knownClientScriptOpNames: Record<number, string> = {
    ...rs3opnames,
    ...(Object as any).fromEntries(Object.entries(namedClientScriptOps).map((q: any) => [q[1], q[0]]))
};
(globalThis as any).knownClientScriptOpNames = knownClientScriptOpNames;
