...
export async function extractClientModuleCode(output: ScriptOutput, outdir: ScriptFS, source: CacheFileSource, entryscripts: number[]) {
    ...
    (globalThis as any).cs2mod = mod;//TODO remove
...
(globalThis as any).IsolatedCS2Module = IsolatedCS2Module;
...
(globalThis as any).analizeCallGraph = analyzeCallGraph;
...
(globalThis as any).alanyzeFull = alanyzeFull;
