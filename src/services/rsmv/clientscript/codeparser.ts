...
function* whitespace(): Generator<any, any, any> {
    while (true) {
        let match = yield [/^\/\/.*\n/, /^\/\*[\s\S]*?\*\//, /^\s+/, ""];
        if (match === "") { break; }
    }
...
(globalThis as any).prettyjson = prettyJson;
...
function scriptContext(ctx: ParseContext) {
        ...
        if (!match) {
            ...
            if (match[1] == "script") {
                ...
                if (match[2] == "bit") {
                    ...
                    let source = (variableSources as any)[match[3]];
    ...
    function* argumentDeclaration(): Generator<any, any, any> {
    ...
    function* typeDeclaration(): Generator<any, any, any> {
        let first = yield [/^\w+/, "["];
    ...
    function* stringInterpolation(): Generator<any, any, any> {
        yield "`";
        let parts: AstNode[] = [];
        let str = "";
        while (true) {
    ...
    function* literalcast(): Generator<any, any, any> {
        if (yield has("as")) {
            yield whitespace;
    ...
    function* stringliteral(): Generator<any, any, any> {
        yield '"';
        let str = "";
        while (!(yield has('"'))) {
            let char = yield ["\\", /^[^"]/];
    ...
    function* intliteral(): Generator<any, any, any> {
    ...
    function* longliteral(): Generator<any, any, any> {
    ...
    function* varname(): Generator<any, any, any> {
        const [name]: [string] = yield (/^[a-zA-Z$][\w$]*/);
        if (reserverd.includes(name)) { yield unmatchable; }
        return name;
    }

    function* valueList(): Generator<any, any, any> {
        let args: any[] = [];
        while (true) {
    ...
    function* call(): Generator<any, any, any> {
    ...
    function* returnStatement(): Generator<any, any, any> {
        yield "return";
        yield whitespace;
    ...
    function* assignStatement(): Generator<any, any, any> {
    ...
    function* switchCaseEntry(): Generator<any, any, any> {
        let value = 0;
    ...
    function* switchStatement(): Generator<any, any, any> {
        yield "switch";
        yield whitespace;
        yield "(";
        yield whitespace;
    ...
    function* controlStatement(): Generator<any, any, any> {
        let type = yield ["break", "continue"];
        yield whitespace;
        return new ControlStatementNode(-1, type);
    }

    function* ifStatement(): Generator<any, any, any> {
        yield "if";
        yield whitespace;
        yield "(";
        yield whitespace;
    ...
    function* readVariable(): Generator<any, any, any> {
        let preop = yield ["++", "--", ""];
    ...
    function* bracketedValue(): Generator<any, any, any> {
        yield "(";
        yield whitespace;
    ...
    function* whileStatement(): Generator<any, any, any> {
        yield "while";
        yield whitespace;
        yield "(";
        yield whitespace;
    ...
    function* valueStatement(): Generator<any, any, any> {
    ...
    function* valueTuple(): Generator<any, any, any> {
    ...
    function* literal(): Generator<any, any, any> {
        return yield [intliteral, stringliteral, longliteral];
    }

    function* statement(): Generator<any, any, any> {
    ...
    function* statementlist(): Generator<any, any, any> {
        let statements: any[] = [];
        yield whitespace;
        while (true) {
    ...
    function* codeBlock(): Generator<any, any, any> {
        yield "{";
    ...
    function* functionStatement(): Generator<any, any, any> {
        yield whitespace;
        yield "function";
        yield whitespace;
