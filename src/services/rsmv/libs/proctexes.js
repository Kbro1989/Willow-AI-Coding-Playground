...
(function () {
    ...
    class Random {
        ...
        static twoToTheXMinus24_$LI$() {
            Random.__static_initialize(); if (Random.twoToTheXMinus24 == null) {
        ...
        static twoToTheXMinus48_$LI$() {
            Random.__static_initialize(); if (Random.twoToTheXMinus48 == null) {
    ...
    class TextureMathUtils {
        ...
        static INVERSE_SQUARE_ROOT_$LI$() {
            TextureMathUtils.__static_initialize(); if (TextureMathUtils.INVERSE_SQUARE_ROOT == null) {
    ...
    class TextureOp extends Node {
        ...
        static permutations_$LI$() {
            if (TextureOp.permutations == null) {
    ...
    class Texture extends SecondaryNode {
        ...
        static brightnessMap_$LI$() {
            if (Texture.brightnessMap == null) {
                Texture.brightnessMap = (s => {
                    let a = []; while (s-- > 0)
                        a.push(0); return a;
                })(256);
    ...
    class MonochromeImageCache {
        ...
        static PERLIN_FADE_$LI$() {
            MonochromeImageCache.__static_initialize(); if (MonochromeImageCache.PERLIN_FADE == null) {
