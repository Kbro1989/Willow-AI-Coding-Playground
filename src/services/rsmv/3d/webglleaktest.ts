...
export function hookgltextures() {
	...
	WebGL2RenderingContext.prototype.bufferData = function (...args: any[]) {
		(oldbufferdata as any).call(this, ...args);
		let size = 0;
	...
	(globalThis as any).texlist = texlist;
	(globalThis as any).buflist = buflist;
	(globalThis as any).dumptexx = dumptexx;
	(globalThis as any).alltex = alltex;
	(globalThis as any).cleartex = cleartex;
