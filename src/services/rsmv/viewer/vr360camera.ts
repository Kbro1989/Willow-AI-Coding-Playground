import { BufferGeometry, Camera, CubeCamera, DoubleSide, LinearFilter, Mesh, OrthographicCamera, PlaneGeometry, RawShaderMaterial, RGBAFormat, Scene, WebGLCubeRenderTarget, WebGLRenderer, ColorSpace } from "three";
...
export class VR360Render {
	...
	constructor(parent: WebGLRenderer, size: number, near: number, far: number) {
		...
		this.cubeRenderTarget = new WebGLCubeRenderTarget(size, {
			...
			format: RGBAFormat,
			colorSpace: parent.outputColorSpace as ColorSpace,
