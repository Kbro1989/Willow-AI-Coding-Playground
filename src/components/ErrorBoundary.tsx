    ...
    public render() {
        if (this.state.hasError) {
            return this.props.fallback || (
                <div className="flex flex-col items-center justify-center h-screen w-screen bg-[#050a15] text-white p-10 font-sans">
                    <div className="bg-red-950/20 border border-red-500/30 p-10 rounded-3xl max-w-2xl w-full shadow-2xl">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-red-600 hover:bg-red-500 text-white font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-red-500/20"
                        >
